                                    ...
                                    <div class="tab-content" id="myTabContent-<?php echo $k ?>">
                                        <div class="tab-pane fade show active" id="info-<?php echo $k ?>" role="tabpanel" aria-labelledby="info-tab-<?php echo $k ?>">
                                            ...
                                            if ($profipaints_modal_id !== '') {
                                                echo '<p class="text-center"><a href="#" class="btn btn-medium btn-primary" data-bs-toggle="modal" data-bs-target="#' . esc_attr($profipaints_modal_id) . '" data-title="' . esc_html($f['title']) . '">' . esc_html__('Заказать', 'profipaints') . '</a></p>';
                                            }
                                            ?>
                                        </div>
                                        <?php
