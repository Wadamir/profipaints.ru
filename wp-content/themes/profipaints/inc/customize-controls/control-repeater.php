 ...
 * @access public
 */
class Profipaints_Customize_Repeatable_Control extends WP_Customize_Control
{
    ...
    public function __construct($manager, $id, $args = array())
    {
        ...
        if (!isset($args['allow_unlimited']) || $args['allow_unlimited'] != false) {
            $this->max_item =  apply_filters('profipaints_reepeatable_max_item', absint($args['max_item']));
        } else {
            $this->max_item = absint($args['max_item']);
        }

        $this->changeable =  isset($args['changeable']) && $args['changeable'] == 'no' ? 'no' : 'yes';
        $this->default_empty_title =  isset($args['default_empty_title']) && $args['default_empty_title'] != '' ? $args['default_empty_title'] : esc_html__('Item', 'profipaints');
    }
    ...
    public function to_json()
    {
        ...
        if ($this->id_key == 'section_id') {
            foreach ((array) $value as $k => $v) {
                ...
                if (!Profipaints_Config::is_section_active($v['section_id'])) {
...
?>
    ...
    ?>
        ...
        <div class="repeatable-actions">
            <span class="button-secondary add-new-repeat-item"><?php echo ($this->add_text) ? esc_html($this->add_text) : __('Add an item', 'profipaints'); ?></span>
        </div>
    <?php
    }
            ...
            <div class="widget">
                <div class="widget-top">
                    ...
                    <div class="widget-title">
                        <h4 class="live-title"><?php _e('Item', 'profipaints'); ?></h4>
                    </div>
                </div>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <# } #>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <# if ( !field.media || field.media=='' || field.media=='image' ) { #>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <# } #>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <div class="actions">
                                                                                                                                                                                                                    <button class="button remove-button " <# if ( ! field.value.url ){ #> style="display:none"; <# } #> type="button"><?php _e('Remove', 'profipaints') ?></button>
                                                                                                                                                                                                                    <button class="button upload-button" data-media="{{field.media}}" data-add-txt="<?php esc_attr_e('Add', 'profipaints'); ?>" data-change-txt="<?php esc_attr_e('Change', 'profipaints'); ?>" type="button">
                                                                                                                                                                                                                        <# if ( ! field.value.url ){ #> <?php _e('Add', 'profipaints'); ?> <# } else { #> <?php _e('Change', 'profipaints'); ?> <# } #>
                                                                                                                                                                                                                    </button>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <# } else if ( field.type=='textarea' || field.type=='editor' ) { #>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <# } else if ( field.type=='icon' ) { #>
                                                                                                                                                                                                                        <# var icon_class=field.value; if ( icon_class.indexOf( 'fa-' ) !=0 ) { icon_class='fa-' + field.value; } else { icon_class=icon_class.replace( 'fa ' , '' ); } icon_class=icon_class.replace( 'fa-fa' , '' ); #>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <a href="#" class="remove-icon"><?php esc_html_e('Remove', 'profipaints'); ?></a>
                                                                                                                                                                                                                            <# } #>
                                                                        ...
                                                                        <div class="widget-control-actions">
                                                                            <div class="alignleft">
                                                                                <span class="remove-btn-wrapper">
                                                                                    <a href="#" class="repeat-control-remove" title=""><?php _e('Remove', 'profipaints'); ?></a> |
                                                                                </span>
                                                                                <a href="#" class="repeat-control-close"><?php _e('Close', 'profipaints'); ?></a>
                                                                            </div>
                                                                            <br class="clear">
                                                                        </div>
