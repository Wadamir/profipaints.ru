...
$wp_customize->add_section(
    'profipaints_aboutus_settings',
    array(
        'priority'    => 3,
        'title'       => esc_html__('Section Settings', 'profipaints'),
        'description' => '',
        'panel'       => 'profipaints_aboutus',
    )
);

// Show Content
$wp_customize->add_setting(
    'profipaints_aboutus_disable',
    array(
...
$wp_customize->add_control(
    ...
    array(
        ...
        'section'     => 'profipaints_aboutus_settings',
...
// Section ID
$wp_customize->add_setting(
    'profipaints_aboutus_id',
    array(
        'sanitize_callback' => 'profipaints_sanitize_text',
        'default'           => esc_html__('aboutus', 'profipaints'),
    )
);
$wp_customize->add_control(
    'profipaints_aboutus_id',
...
// profipaints_add_upsell_for_section( $wp_customize, 'profipaints_aboutus_settings' );

/*
$wp_customize->add_section(
    'profipaints_aboutus_content',
    array(
        'priority'    => 6,
...
$wp_customize->add_control(
    new Profipaints_Customize_Repeatable_Control(
        ...
        array(
            ...
            'description'   => '',
            'section'       => 'profipaints_aboutus_content',
            ...
            'limited_msg'     => wp_kses_post(__('Upgrade to <a target="_blank" href="https://www.famethemes.com/plugins/profipaints-plus/?utm_source=theme_customizer&utm_medium=text_link&utm_campaign=profipaints_customizer#get-started">ProfiPaints Plus</a> to be able to add more items and unlock other premium aboutus!', 'profipaints')),
            'fields'    => array(
                'title'  => array(
