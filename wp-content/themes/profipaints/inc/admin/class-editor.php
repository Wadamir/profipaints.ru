 ...
 * @since 2.2.0
 */
class ProfiPaints_Editor
{
    private $action = 'profipaints_load_editor_style';
    ...
    function assets()
    {
        if (function_exists('profipaints_typography_render_style')) {
            $typo = profipaints_typography_render_style(false, true);
            if ($typo['url']) {
                wp_enqueue_style('profipaints-editor-fonts', $typo['url']); // Font style url.
            }
