...
(function ($, window, document, undefined) {
    ...
    if (Profipaints_Bully.disable_mobile) {
    ...
    (function update() {
        if (frameRendered !== true) {
            ...
            $.each(Profipaints_Bully.sections, function (id, arg) {
                var element = $("#" + id);
            ...
            if (
                lastItemId &&
                typeof Profipaints_Bully.sections[lastItemId] !== "undefined"
            ) {
                if (Profipaints_Bully.sections[lastItemId].inverse) {
    ...
    function Bully(element, options) {
        ...
        if (Profipaints_Bully.enable_label) {
            if (id && typeof Profipaints_Bully.sections[id] !== "undefined") {
                label = Profipaints_Bully.sections[id].title;
            }
            if (label) {
                $bullet.append(
...
jQuery(document).ready(function ($) {
    $.each(Profipaints_Bully.sections, function (id, args) {
        if (args.enable) {
            $("#" + id).bully({
