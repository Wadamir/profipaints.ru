(function (api) {
    ...
    api.sectionConstructor['profipaints-plus'] = api.Section.extend({
        ...
        _init: function () {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'profipaints_section_order_styling') {
    ...
    function _the_editor(container) {
        var _editor = {
            ...
            ready: function (container) {
                ...
                control.container.addClass('profipaints-editor-added');
...
jQuery(window).ready(function ($) {
    ...
    if (typeof profipaints_customizer_settings !== "undefined") {
        if (profipaints_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + profipaints_customizer_settings.action_url + '">' + profipaints_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $('select[data-customize-setting-link="profipaints_hero_layout"]').on('change on_custom_load', function () {
        var v = $(this).val() || '';

        $("li[id^='customize-control-profipaints_hcl']").hide();
        $("li[id^='customize-control-profipaints_hcl" + v + "']").show();

    });
    $('select[data-customize-setting-link="profipaints_hero_layout"]').trigger('on_custom_load');


    /**
     * For Gallery content settings
     */
    $('select[data-customize-setting-link="profipaints_gallery_source"]').on('change on_custom_load', function () {
        var v = $(this).val() || '';

        $("li[id^='customize-control-profipaints_gallery_source_']").hide();
        $("li[id^='customize-control-profipaints_gallery_api_']").hide();
        $("li[id^='customize-control-profipaints_gallery_settings_']").hide();
        $("li[id^='customize-control-profipaints_gallery_source_" + v + "']").show();
        $("li[id^='customize-control-profipaints_gallery_api_" + v + "']").show();
        $("li[id^='customize-control-profipaints_gallery_settings_" + v + "']").show();

    });

    $('select[data-customize-setting-link="profipaints_gallery_source"]').trigger('on_custom_load');

    /**
     * For Gallery display settings
     */
    $('select[data-customize-setting-link="profipaints_gallery_display"]').on('change on_custom_load', function () {
        var v = $(this).val() || '';
        switch (v) {
            case 'slider':
                $("#customize-control-profipaints_g_row_height, #customize-control-profipaints_g_col, #customize-control-profipaints_g_spacing").hide();
                break;
            case 'justified':
                $("#customize-control-profipaints_g_col, #customize-control-profipaints_g_spacing").hide();
                $("#customize-control-profipaints_g_row_height").show();
                break;
            case 'carousel':
                $("#customize-control-profipaints_g_row_height, #customize-control-profipaints_g_col").hide();
                $("#customize-control-profipaints_g_col, #customize-control-profipaints_g_spacing").show();
                break;
            case 'masonry':
                $("#customize-control-profipaints_g_row_height").hide();
                $("#customize-control-profipaints_g_col, #customize-control-profipaints_g_spacing").show();
                break;
            default:
                $("#customize-control-profipaints_g_row_height").hide();
    ...
    $('select[data-customize-setting-link="profipaints_gallery_display"]').trigger('on_custom_load');
