...
(function ($, api) {
    ...
    // Site footer bg
    /*
    wp.customize( 'profipaints_footer_bg', function( value ) {
    ...
    */
    ...
    // Site footer info bg
    wp.customize('profipaints_footer_info_bg', function (value) {
        value.bind(function (to) {
    ...
    // Site footer widgets
    wp.customize('profipaints_btt_disable', function (value) {
        value.bind(function (to) {
            if (to === true || to == 'true') {
    ...
    function update_css() {
        var css_code = $('#profipaints-style-inline-css').html();
        // Fix Chrome Lost CSS When resize ??
        $('#profipaints-style-inline-css').replaceWith('<style class="replaced-style" id="profipaints-style-inline-css">' + css_code + '</style>');
    ...
    wp.customize.selectiveRefresh.bind('partial-content-rendered', function (settings) {
        ...
        if (settings.partial.id == 'profipaints-header-section') {
